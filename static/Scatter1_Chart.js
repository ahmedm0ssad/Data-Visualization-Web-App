function fetchDataAndUpdateChart8() {
    fetch("/get-sales-intensity2-data")
    ...
    //      todo  <div id="Scatter1_chartdiv"></div>
    function updateChart8(data) {
    am5.ready(function () {
        // Create root element
        // https://www.amcharts.com/docs/v5/getting-started/#Root_element
        // sourcery skip: avoid-using-var
        var root = am5.Root.new("Scatter1_chartdiv");
        ...
        am5xy.LineSeries.new(root, {
            ...
            valueXField: "totalDiscounts ",
            valueField: "product",
            tooltip: am5.Tooltip.new(root, {
            labelText:
                "totalDiscounts : {valueX}, totalProfit: {valueY}, Product: {value}",
            }),
        })
        );
